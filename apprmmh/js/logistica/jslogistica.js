...
$(function(){
	...
	$("#iddepto").cargarCombo("idmpio","logistica/actualizarmunicipios");
	$("#iddeptoest").cargarCombo("idmpioest","logistica/actualizarmunicipios");
	...
	function obtenerSalario(){
		...
		$.ajax({
			type: "POST",
			url: base_url + "logistica/obtenerSalario",
			dataType: "json",
			cache: false,
	...
	if((typeof(numord)!="undefined")&&(typeof(numest)!="undefined")){
		...
		$.ajax({
			type: "POST",
			url: base_url + "logistica/obtenerObservaciones/"+numord+"/"+numest,
	...
	$("#btnBuscarLOG").click(function(){
		...
		$.ajax({
			type: "POST",
			url: base_url + "logistica/buscarFuentes",
			data: {'opcion': opcion,
				   'buscar': buscar
		    },
			dataType: "html", 
	...
	$("#cmbFuenteLOG").change(function(){
		$.ajax({
			type: "POST",
			url: base_url + "logistica/obtenerDatosFuente",
	...
	$("#btnRemoverFTELOG").click(function(){
		$.ajax({
			type: "POST",
			url: base_url + "logistica/removerFuente",
			data: $("#frmRemoverFTE").serialize(),
			dataType: "html", 
		    cache: false,
			success: function(data){
	...
	$("#btnOBSLogisticaI").click(function(){		
		if ($("#frmModuloI").valid()){
			$("#hddCapitulo").val(1);
			$("#txaObservacionesLOG").val("");
			$("#observacionesLOG").dialog({
				width: 480,
	...
	$("#btnGuardarCriticaLOG").click(function(){
		...
		else
		{
			$.ajax({
				type: "POST",
				url: base_url + "logistica/guardarCapitulo",
				data: {'observacion': $("#txaObservacionesLOG").val(), 'capitulo':$("#hddCapitulo").val(), 'form': $(formulario).serialize()},
				dataType: "html",
			    cache: false,
				success: function(data){
					$("#observacionesLOG").dialog("close");
