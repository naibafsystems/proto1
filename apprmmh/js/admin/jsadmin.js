...
$(function(){
	...
	if((typeof(numord)!="undefined")&&(typeof(numest)!="undefined")){
		...
		//Lanzo función ajax para saber si la fuente ha diligenciado justificaciones para este capitulo y mostrarlas en el recuadro. (Modulo 3)
		$.ajax({
			type: "POST",
			url: base_url + "administrador/obtenerObservaciones/"+numord+"/"+numest,
		...
		//Lanzo función ajax para saber si la fuente ha diligenciado justificaciones para este capitulo y mostrarlas en el recuadro. (Modulo 4)
		$.ajax({
			type: "POST",
			url: base_url + "administrador/obtenerObservaciones/"+numord+"/"+numest,
	...
	//Valida el envío del formulario de agregar empresas
	...
	//Valida el envío del formulario de agregar establecimientos
