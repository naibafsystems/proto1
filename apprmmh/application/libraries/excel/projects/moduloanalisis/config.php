...
define('SW_DB_USER', 'dimpe');
define('SW_DB_PASSWORD', 'D1mP3D3s4rr0ll0');
define('SW_DB_HOST', '192.168.1.200');
define('SW_DB_DATABASE', 'dimpe_rmmh');
}
