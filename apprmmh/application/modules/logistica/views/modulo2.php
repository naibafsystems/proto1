...
<br/>
<?php //Validar que el formulario esté en estado 99 - 4 para que pueda ser utlizado / modificado por el logistico
	  //if (($novedad_estado["novedad"]==99)&&($novedad_estado["estado"]==4) || ($novedad_estado["novedad"]==99 && $novedad_estado["estado"]==5)){  
?>  	 <input type="button" id="btnOBSLogisticaII" name="btnOBSLogisticaII" value="Observaciones Log&iacute;stica" class="button"/>        
<?php //} ?>
