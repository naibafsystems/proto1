...
<table width="100%">
  ...
  <tr>
    <th width="27%">Tipo de habitaci&oacute;n</th>
    <th style="text-align:center">N&uacute;mero de habitaciones <br/>vendidas</th>
    <th style="padding-right: 20px; text-align:center">Tarifa promedio por persona<br>(valor en pesos)</th>			  
  </tr>
  </thead>
  <tbody>
  <tr>
...
<?php //Validar que el formulario esté en estado 99 - 5 para poder ser activado por el administrador 
  ...
  ?>  	<center><input type="button" id="btnOBSLogisticaIV" name="btnOBSLogisticaIV" value="Observaciones Log&iacute;stica" class="button"/></center>        
  <?php //} ?>	
