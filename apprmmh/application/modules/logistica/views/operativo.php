  ...
  <tbody>
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["directorio_base"] > 0){ ?>
  	  			<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/0"); ?>"><?php echo $informe["directorio_base"]; ?></a></td>
  	  <?php }else{ ?>			
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["nuevos"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/1"); ?>"><?php echo $informe["nuevos"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["total_recolectar"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/2"); ?>"><?php echo $informe["total_recolectar"]; ?></a></td>
  	  <?php } else { ?>	
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["sin_distribuir"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/3"); ?>"><?php echo $informe["sin_distribuir"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["distribuidos"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/4"); ?>"><?php echo $informe["distribuidos"]; ?></a></td>
  	  <?php } else{ ?>
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["digitacion"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/5"); ?>"><?php echo $informe["digitacion"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["digitados"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/6"); ?>"><?php echo $informe["digitados"]; ?></a></td>
  	  <?php } else { ?>	
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["analisis_verificacion"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/7"); ?>"><?php echo $informe["analisis_verificacion"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["verificados"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/8"); ?>"><?php echo $informe["verificados"]; ?></a></td>
  	  <?php } else { ?>	
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["novedades"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("logistica/detalleOperativo/9"); ?>"><?php echo $informe["novedades"]; ?></a></td>
  	  <?php } else{ ?>	
