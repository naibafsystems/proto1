...
<tr>
  <td>
    <form id="frmBusqueda" name="frmBusqueda" method="post" action="<?php echo site_url("logistica/buscarFuentes"); ?>">
    <fieldset class="fieldset">
  	...
  	<tr>  
  	  ...
  	  <td><input type="button" id="btnBuscarLOG" name="btnBuscarLOG" value="Buscar" class="button"/></td>  	  
  	</tr>
  	<tr>
  	</tr>
  	</table>   	
