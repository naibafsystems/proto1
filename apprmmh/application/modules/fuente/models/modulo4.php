...
class Modulo4 extends CI_Model {
    ...
    function obtenerModulo($nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$modulo4 = array();
    	$sql = "SELECT C.modulo4, CH.ihdo, CH.ihoa, CH.icda, CH.icva, CH.ihpn, CH.ihpnr, CH.huetot, CH.mvnr, CH.mvnnr, CH.mvcr, CH.mvcnr, CH.mvor, CH.mvonr,
                       CH.mvsr, CH.mvsnr, CH.mvotr, CH.mvotnr, CH.mvott, CH.mvottnr, CH.thsen, CH.thusen, CH.thdob, CH.thudob, CH.thsui, CH.thusui, CH.thmult, CH.thumult, CH.thotr, CH.thuotr, CH.thtot
    ...
    function actualizarModulo($ihdo, $ihoa, $icda, $icva, $ihpn, $ihpnr, $huetot, $mvnr, $mvcr, $mvor, $mvsr, $mvotr, $mvott, $mvnnr, $mvcnr, $mvonr, $mvsnr, $mvotnr, $mvottnr, $thsen, $thusen, $thdob, $thudob, $thsui, $thusui, $thmult, $thumult, $thotr, $thuotr, $thtot, $tphto, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    ...
    function insertarModulo($ihdo, $ihoa, $icda, $icva, $ihpn, $ihpnr, $huetot, $mvnr, $mvcr, $mvor, $mvsr, $mvotr, $mvott, $mvnnr, $mvcnr, $mvonr, $mvsnr, $mvotnr, $mvottnr, $thsen, $thusen, $thdob, $thudob, $thsui, $thusui, $thmult, $thumult, $thotr, $thuotr, $thtot, $tphto, $nro_orden, $nro_establecimiento, $ano_periodo, $mes_periodo){
    	$data = array('ihdo' => $ihdo, 'ihoa' => $ihoa,  
    	              'icda' => $icda, 'icva' => $icva, 
    	              'ihpn' => $ihpn, 'ihpnr' => $ihpnr, 
    	              'huetot' => $huetot, 'mvnr' => $mvnr, 
