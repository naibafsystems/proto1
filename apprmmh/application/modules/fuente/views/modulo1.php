...
<td>
	<table width="100%">
	<tr>
	  <td><label style="display: block; float: left; width: 820px;">Domicilio principal o direcci&oacute;n de la gerencia:&nbsp;<input type="text" id="iddirecc" name="iddirecc" value="<?php echo $modulo1["iddirecc"]; ?>" size="80" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
	</tr>
	</table>
</td>
</tr>
...
<td>
    <table width="100%">
    <tr>
      <td><label style="display: block; float: left; width: 620px;">Email gerencia:&nbsp;<input type="text" id="idcorreo" name="idcorreo" value="<?php echo $modulo1["idcorreo"]; ?>" size="80" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
    </tr>
    </table>
</td>
</tr>
...
<td>
    ...
    <tr>
      <td><input type="text" id="finicial" name="finicial" value="<?php //echo $modulo1["finicial"]; ?>" class="textbox" <?php //$this->general->bloqueoCampo($bloqueo); ?>/></td>
      <td>&nbsp;</td>
      <td><input type="text" id="ffinal" name="ffinal" value="<?php //echo $modulo1["ffinal"]; ?>" class="textbox" <?php //$this->general->bloqueoCampo($bloqueo); ?>/></td>
    </tr>
    </table>
</td>
</tr-->
...
<td>
	<table width="100%">
	<tr>
	  <td><label style="display: block; float: left; width: 720px;">Nombre del establecimiento:&nbsp;&nbsp;&nbsp;<input type="text" id="idnomcomest" name="idnomcomest" value="<?php echo $modulo1["idnomcomest"]; ?>" size="80" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?> /></label>
	      <label style="display: block; float: left; width: 200px;">Sigla:&nbsp;<input type="text" id="idsiglaest" name="idsiglaest" value="<?php echo $modulo1["idsiglaest"]; ?>" size="20" maxlength="20" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label>
	  </td>
	</tr>
	</table>
</td>
...
<td>
	<table width="100%">	
	<tr>
	  <td><label style="display: block; float: left; width: 720px;">Direcci&oacute;n del establecimiento:&nbsp;<input type="text" id="iddireccest" name="iddireccest" value="<?php echo $modulo1["iddireccest"]; ?>" size="80" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
	</tr>
	</table>
</td>
</tr>
...
<td>
	<table width="100%">
	<tr>
	  <td><label style="display: block; float: left; width: 220px;">Tel&eacute;fono:&nbsp;<input type="text" id="idtelnoest" name="idtelnoest" value="<?php echo $modulo1["idtelnoest"]; ?>" size="13" maxlength="13" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
	  ...
	  <td><label style="display: block; float: left; width: 550px;">Email establecimiento:&nbsp;<input type="text" id="idcorreoest" name="idcorreoest" value="<?php echo $modulo1["idcorreoest"]; ?>" size="60" maxlength="80" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></label></td>
	</tr>
	</table>
</td>  
</tr>
