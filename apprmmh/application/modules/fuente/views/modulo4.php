...
<h3>M&oacute;dulo IV - Caracter&iacute;sticas de los hoteles</h3>
<br/>
...
<table width="100%">
  ...
  <tr>
  	<td colspan="3">
  		<p style="color:red">NOTA: * Infraestructura -capacidad de alojamiento- no incluye supletorias o adicionales. 
  	</td>
  </tr>
  </tbody>
</table>
...
<table width="100%">
  ...
  <tr>
    ...
    <th width="" style="padding-right: 20px; text-align:center">Tarifa promedio por tipo de acomodación<br> (valor en pesos)</th>			  
  </tr>
  </thead>
  <tbody>
  <tr>
...
<br/>
<?php if (!$bloqueo){ ?>
	<center><input type="submit" id="btnModuloIV" name="btnModuloIV" value="Guardar y continuar" class="button"/></center>
<?php } ?>	
