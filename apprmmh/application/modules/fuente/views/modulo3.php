...
<form id="frmModuloIII" name="frmModuloIII" method="post" action="">
  ...
  <tr>
	<td>4. Servicios receptivos (city tours, guías tur&iacute;sticos y servicios similares).</td>
  ...
  <tr>
	<td>6. Otros ingresos  operacionales no solicitados antes (Incluye comunicaciones, lavander&iacute;a, peluquer&iacute;a, etc.).<br/>&nbsp;</td>
  ...
  <br/>
  <?php if (!$bloqueo){ ?>
  	<input type="submit" id="btnModuloIII" name="btnModuloIII" value="Guardar y continuar" class="button"/>
  <?php } ?>
