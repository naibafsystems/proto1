...
<br>
<h3><center>ENVIAR FORMULARIO</center></h3>			
<br/>
<form id="frmModuloEnvio" name="frmModuloEnvio" method="post" action="">
<table width="100%">
<tr>
  <td colspan="1" align="left">Observaciones (M&aacute;ximo 500 caracteres)<textarea id="fteObserv" name="fteObserv" style="width: 99%;" rows="3" <?php $this->general->bloqueoCampo($bloqueo); ?> class="textbox"><?php echo $envio["observaciones"]; ?></textarea></td>			      
</tr>
<tr>
  <td colspan="1">&nbsp;</td>
</tr>
...
<?php if (!$bloqueo){ ?>
<center><input type="submit" id="btnModuloEnvio" name="btnModuloEnvio" value="Guardar y enviar" class="button"/></center>
<?php } ?>
