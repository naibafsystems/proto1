...
class Control extends CI_Model {
	...
	function informeOperativoAsistente($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede){
		$informeOP = array();
     	$informeOP["directorio_base"] = $this->directorioBase($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
		$informeOP["nuevos"] = $this->nuevos($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
		$informeOP["total_recolectar"] = $informeOP["directorio_base"] + $informeOP["nuevos"];
		$informeOP["sin_distribuir"] = $this->sinDistribuir($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
		$informeOP["distribuidos"] = $this->distribuidos($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
     	$informeOP["digitacion"] = $this->digitacion($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
     	$informeOP["digitados"] = $this->digitados($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
     	$informeOP["analisis_verificacion"] = $this->analisisVerificacion($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
     	$informeOP["verificados"] = $this->verificados($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
     	$informeOP["novedades"] = $this->novedades($usuarioCR, $usuarioLOG, $ano_periodo, $mes_periodo, $sede, $subsede);
    ...
    //Se cambia el query para que solo tenga en cuenta las novedades que han sido aprobadas.
