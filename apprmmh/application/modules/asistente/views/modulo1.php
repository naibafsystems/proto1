...
<td>
  <table>
  <tr>
    <td><label style="display: block; float: left; width: 660;">Raz&oacute;n Social:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="idproraz" name="idproraz" value="<?php echo $modulo1["idproraz"]; ?>" size="80" maxlength="80" class="textbox"/></label>
...
?>		  <input type="button" id="btnOBSAsistenteI" name="btnOBSAsistenteI" value="Observaciones Asistente" class="button"/>
<?php } ?>
