...
<tr>
  <td>
    <form id="frmBusqueda" name="frmBusqueda" method="post" action="<?php echo site_url("asistente/buscarFuentes"); ?>">
    <fieldset class="fieldset">
  	...
  	<tr>  
  	  ...
  	  <td><input type="button" id="btnBuscarAST" name="btnBuscarAST" value="Buscar" class="button"/></td>  	  
  	</tr>
  	<tr>
  	</tr>
  	</table>   	
