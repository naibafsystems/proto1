...
<br/>
<?php //Validar que el formulario esté en estado 99 - 4 para poder ser activado por el asistente 
	  if (($novedad_estado["novedad"]==99)&&($novedad_estado["estado"]==4)){  
?>  	  <center><input type="button" id="btnOBSAsistenteV" name="btnOBSAsistenteV" value="Observaciones Asistente" class="button"/></center>        
<?php } ?>
