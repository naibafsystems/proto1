...
<br/>
<form id="frmUPDusuario" name="frmUPDUsuario" method="post" action="<?php echo site_url("asistente/actualizarUsuario"); ?>">
<table width="100%">
<tr>
...
<tr>
    ...
    <td><input type="text" id="txtNomUsuario" name="txtNomUsuario" value="<?php echo $usuario["nombre"]; ?>" size="50" class="textbox"/></td>
</tr>
<tr>
    <td>Login: </td>
    ...
    <td><select id="cmbsubsede" name="cmbsubsede" class="select">
        ...
        <?php for ($i=0; $i<count($subsedes); $i++){
     	          if ($usuario["subsede"]==$subsedes[$i]["id"])	
         		     echo '<option value="'.$subsedes[$i]["id"].'" selected="selected">'.$subsedes[$i]["nombre"].'</option>';
         		  else		
