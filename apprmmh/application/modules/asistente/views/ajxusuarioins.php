...
<?php $this->load->helper("url"); ?>
   ...
   <br/>
   <form id="frmINSusuario" name="frmINSusuario" method="post" action="<?php echo site_url("asistente/insertarUsuario"); ?>">
   <table width="100%">
   <tr>
   ...
   <tr>
     <td>Login: </td>
     <td><input type="text" id="txtLogin" name="txtLogin" value="" class="textbox" maxlength="20"/></td>
   </tr>
   <tr>
     <td>Password: </td>
   ...
   <tr>
     ...
     <td><select id="cmbRol" name="cmbRol" class="select">
         ...
         <option value="3">Asistente T&eacute;cnico</option>
         <option value="2">Cr&iacute;tico</option>         
         </select>
     </td>
   </tr>
   <tr>
