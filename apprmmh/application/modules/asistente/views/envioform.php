...
<table width="100%">
<tr>
  <td colspan="1" align="left">Observaciones (M&aacute;ximo 500 caracteres)<textarea id="fteObserv" name="fteObserv" style="width: 99%;" rows="5" <?php $this->general->bloqueoCampo($bloqueo); ?> class="textbox"><?php echo $envio["observaciones"]; ?></textarea></td>			      
</tr>
<tr>
  <td colspan="1">&nbsp;</td>
</tr>
<tr>
 ...
 <?php //Validar que el formulario esté en estado 99 - 5 para poder ser activado por el administrador 
  ...
  ?>  	<center><input type="button" id="btnOBSAsistenteENV" name="btnOBSAsistenteENV" value="Observaciones Asistente" class="button"/></center>
  <?php } ?>
