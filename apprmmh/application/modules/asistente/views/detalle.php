...
<div id="observacionesAST">
<form id="frmObservacionesAST" name="frmObservacionesAST" method="post" action="">
<table width="100%">
<tr>
...
<tr>
  ...
  <td><textarea id="txaObservacionesAST" name="txaObservacionesAST" rows="5" style="width: 95%" class="textbox"></textarea></td>
</tr>
<tr>
  <td colspan="2">&nbsp;</td>
</tr>
<tr>
  <td width="15%">&nbsp;</td>
  <td><input type="button" id="btnGuardarCriticaAST" name="btnGuardarCriticaAST" value="Guardar Observaciones Asistente" class="button"/></td>
</tr>
</table>
