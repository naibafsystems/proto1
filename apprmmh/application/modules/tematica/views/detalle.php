...
<tr>
  ...
  <td><textarea id="txaObservacionesADM" name="txaObservacionesADM" rows="5" style="width: 95%" class="textbox"></textarea></td>
</tr>
<tr>
  <td colspan="2">&nbsp;</td>
</tr>
<tr>
  <td width="15%">&nbsp;</td>
  <td><input type="button" id="btnGuardarCriticaADM" name="btnGuardarCriticaADM" value="Guardar Observaciones Administrador" class="button"/></td>
</tr>
</table>
