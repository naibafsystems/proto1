...
<tr>
  <td>
    <form id="frmBusqueda" name="frmBusqueda" method="post" action="<?php echo site_url("tematica/buscarFuentes"); ?>">
    <fieldset class="fieldset">
  	...
  	<tr>  
  	  ...
  	  <td><!-- <input type="button" id="btnBuscarADM" name="btnBuscarADM" value="Buscar" class="button"/> -->
  	      <input type="submit" id="btnBuscarADM" name="btnBuscarADM" value="Buscar" class="button"/>
  	  </td>  	  
  	</tr>
  	<tr>
  	</tr>
