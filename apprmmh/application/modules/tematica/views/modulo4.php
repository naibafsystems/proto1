...
<table width="100%">
  ...
  <tr>
    <th width="22%">Motivo de viaje</th>
	<th width="19%">Residentes %</th>
	<th width="19%">No Residentes %</th>
  </tr>
  </thead>
  <tbody>
  <tr>
  ...
  <tr>
    <td><label>4. Salud y atenci&oacute;n m&eacute;dica (Incluye tratamientos de <br>atenci&oacute;n est&eacute;tica)</label></td>
...
<table width="100%">
  ...
  <tr>
    ...
    <th width="25%" style="padding-right: 20px; text-align:center"><span id="">Tarifa promedio por persona. <br>(valor en pesos)</span></th>			  
  </tr>
  </thead>
  <tbody>
  <tr>
