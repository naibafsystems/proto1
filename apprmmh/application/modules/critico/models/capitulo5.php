...
class Capitulo5 extends CI_Model {
	...
	function obtenerCapitulo($nro_orden, $uni_local, $ano_periodo, $mes_periodo){
    	$cap5 = array();
    	$sql = "SELECT C.cap4, CH.habdia, CH.ihdo, CH.ihoa, CH.camdia, CH.icda, CH.icva, CH.ihpn, CH.ihpnr, CH.huetot, CH.mvnr, CH.mvnnr, CH.mvcr, CH.mvcnr, 
    	               CH.mvor, CH.mvonr, CH.mvsr, CH.mvsnr, CH.mvotr, CH.mvotnr, CH.mvott, CH.mvottnr, CH.thsen, CH.ingsen, CH.inalosen, CH.thdob, 
    	               CH.ingdob, CH.inalodob, CH.thsui, CH.ingsui, CH.inalosui, CH.thmult, CH.ingmult, CH.inalomul, CH.thotr, CH.ingotr, CH.inalootr, 
    	               CH.thtot, CH.ingtot, CH.inalotot
