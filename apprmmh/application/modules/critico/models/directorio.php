...
class Directorio extends CI_Model {
    ...
    //Realiza el conteo de las fuentes que han sido asignadas a un critico. se utiliza en el paginador de busqueda de formularios del critico
    function contarDirectorioCritico($ano_periodo, $mes_periodo, $idcritico, $opcion, $busqueda){
    	$total = 0;
	...
	function buscarDirectorioCritico($ano_periodo, $mes_periodo, $idcritico, $opcion, $busqueda){
	...
	function buscarDirectorioCriticoPagina($ano_periodo, $mes_periodo, $idcritico, $opcion, $busqueda, $desde, $hasta){
   		$this->load->model("sede");
   		$this->load->model("subsede");
   		$this->load->model("divipola");   		
   		$directorio = array();
