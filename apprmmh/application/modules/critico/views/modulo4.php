...
<table width="100%">
  ...
  <tr>
    <td><label>4. Salud y atención m&eacute;dica (Incluye tratamientos<br> de atenci&oacute;n est&eacute;tica)</label></td>
...
<table width="100%">
  ...
  <tr>
    <th width="28%">Tipo de habitaci&oacute;n</th>
    <th style="text-align:center">N&uacute;mero de habitaciones <br/>vendidas</th>
    <th style="padding-right: 20px; text-align:center "><span id="">Tarifa promedio por persona <br> (valor en pesos)</span></th>			  
  </tr>
  </thead>
  <tbody>
  <tr>
...
<?php //Validar que el formulario esté en estado 99 - 5 para poder ser activado por el critico 
  ...
  ?>  	<center><input type="button" id="btnOBSCriticaIV" name="btnOBSCriticaIV" value="Observaciones Cr&iacute;tica" class="button"/></center>        
  <?php } ?>	
