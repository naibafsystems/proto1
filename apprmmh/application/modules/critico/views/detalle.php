...
<tr>
  ...
  <td><textarea id="txaObservacionesCR" name="txaObservacionesCR" rows="5" style="width: 95%" class="textbox"></textarea></td>
</tr>
<tr>
  <td colspan="2">&nbsp;</td>
</tr>
<tr>
  <td width="15%">&nbsp;</td>
  <td><input type="button" id="btnGuardarCriticaCR" name="btnGuardarCriticaCR" value="Guardar Observaciones Cr&iacute;tica" class="button"/></td>
</tr>
</table>
