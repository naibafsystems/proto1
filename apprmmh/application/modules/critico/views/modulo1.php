...
<td>
  <table>
  <tr>
    <td><label style="display: block; float: left; width: 660px;">Raz&oacute;n Social:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="idproraz" name="idproraz" value="<?php echo $modulo1["idproraz"]; ?>" size="80" maxlength="80" class="textbox"/></label>
...
<td>
	...
	<tr>
	  <td width="50%">
	      <label style="display: block; float: left; width: 265px;">Departamento: 
	  ...
	  <td>
	  	  <label style="display: block; float: left; width: 480px;">&nbsp;Municipio: 
...
<td>
    <table width="100%">
    <tr>
      <td><label style="display: block; float: left; width: 820px;">Cadena hotelera al que pertenece:&nbsp; <input type="text" id="nom_cadena" name="nom_cadena" value="<?php echo $modulo1["nom_cadena"]; ?>" size="50" maxlength="80" class="textbox"/></label></td>
    </tr>
    </table>
</td>
</tr>
...
?>		  <input type="button" id="btnOBSCriticaI" name="btnOBSCriticaI" value="Observaciones Cr&iacute;tica" class="button"/>
<?php } ?>
