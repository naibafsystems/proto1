<h3>Ingresos operacionales causados en el mes (miles de pesos)</h3>
...
<form id="frmCapituloIII" name="frmCapituloIII" method="post" action="">
  ...
  ?>  	<table>
  		<tr>
    		<td colspan="2"><input type="button" id="btnOBSCriticaIII" name="btnOBSCriticaIII" value="Observaciones Cr&iacute;tica" class="button"/></td>
  		</tr>
  		</table>
  <?php } ?>
