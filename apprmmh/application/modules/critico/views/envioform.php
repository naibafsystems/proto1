...
<table width="100%">
<tr>
  <td align="left">Observaciones (M&aacute;ximo 500 caracteres)<textarea id="fteObserv" name="fteObserv" style="width: 99%;" rows="5" <?php $this->general->bloqueoCampo($bloqueo); ?> class="textbox"><?php echo $envio["observaciones"]; ?></textarea></td>			      
</tr>
<tr>
  <td >&nbsp;</td>
</tr>
<tr>
 ...
 <?php //Validar que el formulario esté en estado 99 - 4 para poder ser activado por el critico 
  ...
  ?>  	<center><input type="button" id="btnOBSEnvio" name="btnOBSEnvio" value="Observaciones Cr&iacute;tica" class="button"/></center>
  <?php } ?>
