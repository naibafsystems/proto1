...
<?php if (count($fuentes)>0){ ?>
	...
	<tr class="<?php echo $class; ?>">
  		<td align="left"><a href="<?php echo base_url("administrador/mostrarFormulario/".$fuentes[$i]["nro_orden"]."/".$fuentes[$i]["nro_establecimiento"]); ?>"><?php echo $fuentes[$i]["nro_orden"]; ?></a></td>
  		<td align="left"><a href="<?php echo base_url("administrador/mostrarFormulario/".$fuentes[$i]["nro_orden"]."/".$fuentes[$i]["nro_establecimiento"]); ?>"><?php echo $fuentes[$i]["nro_establecimiento"]; ?></a></td>  		  		
