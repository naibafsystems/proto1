...
<tr>
  ...
  <td valign="top">
    <a href="<?php echo site_url("administrador/operativoCritico"); ?>"><img src="<?php echo base_url("images/app.png"); ?>" title="" border="0"/>&nbsp;Reporte Operativo por Cr&iacute;tico</a>
  </td> 
</tr>
<tr>
  <td>&nbsp;</td>
  ...
  <tbody>
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["directorio_base"] > 0){ ?>
  	  			<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/0/$sede/$subsede"); ?>"><?php echo $informe["directorio_base"]; ?></a></td>
  	  <?php }else{ ?>			
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["nuevos"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/1/$sede/$subsede"); ?>"><?php echo $informe["nuevos"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["total_recolectar"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/2/$sede/$subsede"); ?>"><?php echo $informe["total_recolectar"]; ?></a></td>
  	  <?php } else { ?>	
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["sin_distribuir"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/3/$sede/$subsede"); ?>"><?php echo $informe["sin_distribuir"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["distribuidos"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/4/$sede/$subsede"); ?>"><?php echo $informe["distribuidos"]; ?></a></td>
  	  <?php } else{ ?>
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["digitacion"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/5/$sede/$subsede"); ?>"><?php echo $informe["digitacion"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["digitados"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/6/$sede/$subsede"); ?>"><?php echo $informe["digitados"]; ?></a></td>
  	  <?php } else { ?>	
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["analisis_verificacion"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/7/$sede/$subsede"); ?>"><?php echo $informe["analisis_verificacion"]; ?></a></td>
  	  <?php } else{ ?>	
  	...
  	<tr class="row1">
  	  ...
  	  <?php if ($informe["verificados"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/8/$sede/$subsede"); ?>"><?php echo $informe["verificados"]; ?></a></td>
  	  <?php } else { ?>	
  	...
  	<tr class="row2">
  	  ...
  	  <?php if ($informe["novedades"] > 0){ ?>
  	  	<td align="center"><a href="<?php echo site_url("administrador/detalleOperativo/9/$sede/$subsede"); ?>"><?php echo $informe["novedades"]; ?></a></td>
  	  <?php } else{ ?>	
