...
<tr>
  ...
  <?php if (count($sinasignar) > 0) { ?>  
    ...
    <thead class="thead">
    <tr>
      <th width="5%">N.Orden</th>
      <th width="5%">N.Estab</th>
      <th width="32%">Nombre Establecimiento</th>
      <th width="10%" align="center">Sede</th>
      <th width="10%" align="center">Subsede</th>
      <th width="5%">&nbsp;</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr class="<?php echo $class; ?>">
      ...
      <td align="center"><?php echo $sinasignar[$i]["sede"]; ?></td>
      <td align="center"><?php echo $sinasignar[$i]["subsede"]; ?></td>      
      <td>
  ...
  <!-- div asignados -->
	  ...
	  <?php if (count($asignados) > 0) { ?>
	    ...
	    <tr class="<?php echo $class; ?>">
	      ...
	      <td align="center"><?php echo $asignados[$j]["sede"]; ?></td>
	      <td align="center"><?php echo $asignados[$j]["subsede"]; ?></td>
