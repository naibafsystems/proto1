...
<h3>M&oacute;dulo IV - Infraestructura y ocupación hotelera</h3>
<br/>
...
<table width="100%">
  ...
  <tr>
	...
	<td><input type="text" id="ihoa" name="ihoa" value="<?php echo $modulo4["ihoa"]; ?>" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></td>
  	<!-- td><input type="text" id="habdia" name="habdia" value="<?php //echo $modulo4["habdia"]; ?>" class="textbox" <?php //$this->general->bloqueoCampo($bloqueo); ?>/></td-->
  	<td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<td><input type="text" id="icva" name="icva" value="<?php echo $modulo4["icva"]; ?>" class="textbox" <?php $this->general->bloqueoCampo($bloqueo); ?>/></td>
  	<!-- td><input type="text" id="camdia" name="camdia" value="<?php //echo $modulo4["camdia"]; ?>" class="textbox" <?php //$this->general->bloqueoCampo($bloqueo); ?>/></td-->
    <td>&nbsp; </td>
  </tr>
  <tr>
...
<table width="100%">
  ...
  <tr>
    <th width="20%">Motivo de viaje</th>
	<th style="text-align:left" width="19%">Residentes %</th>
	<th style="text-align:left" width="19%">No. Residentes %</th>
  </tr>
  </thead>
  <tbody>
  <tr>
  ...
  <tr>
    <td><label><span id="texto2">2. Convenciones (MICE)</span></label></td>
  ...
  <tr>
    <td><label>3. Ocio, recreaci&oacute;n y vacaciones</label></td>
  ...
  <tr>
    <td><label>4.  Salud y atención m&eacute;dica (Incluye tratamientos de atenci&oacute;n est&eacute;tica)</label></td>
...
<table width="100%">
  <thead>
  <tr>
    <th colspan="3">TARIFA PROMEDIO POR TIPO DE ACOMODACI&Oacute;N</th>			  			  
  </tr>
  <tr>
    <th colspan="3">&nbsp;</th>			  			  
  </tr>
  <tr>
    ...
    <!-- th width="25%" style="padding-right: 20px;"><span id="texto2">Total facturado si la tarifa de la habitaci&oacute;n incluye alojamiento y otros  servicios (miles de pesos)</span></th>			  
    <th width="30%">Total facturado si la tarifa de la habitaci&oacute;n s&oacute;lo incluye alojamiento <br/>(miles de pesos)</th-->
  </tr>
  </thead>
  <tbody>
  <tr>
...
<?php //Validar que el formulario esté en estado 99 - 5 para poder ser activado por el administrador 
  ...
  ?>  	<center><input type="button" id="btnOBSAdminIV" name="btnOBSAdminIV" value="Observaciones Administrador" class="button"/></center>       
  <?php } ?>	
