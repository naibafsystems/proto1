...
<br/>
<h1><?php echo $nomlogistico; ?></h1>
<table>
<tr>
  <td valign="top">
  <!-- div sin asignar -->
  <form id="frmSinAsignar" name="frmSinAsignar" method="post" action="<?php echo site_url("administrador/asignarFuentesLogistico"); ?>">
  ...
  <?php if (count($sinasignar) > 0) { ?>  
    ...
    <tr>
      ...
      <th width="35%">Nombre Establecimiento</th>
      <th width="10%">Sede</th>
      <th width="10%">Subsede</th>
      <th width="5%">&nbsp;</th>
    </tr>
    </thead>
    <tbody>
  ...
  <input type="hidden" id="hddLogistico" name="hddLogistico" value="<?php echo $idlogistico; ?>"/>  
  <?php } 
  else {
  ...
  <td valign="top">
  <!-- div asignados -->
	  <form id="frmAsignados" name="frmAsignados" method="post" action="<?php echo site_url("administrador/removerFuentesLogistico"); ?>">
