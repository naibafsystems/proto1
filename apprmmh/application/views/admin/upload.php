...
?> 
		...
		<tr>
		  <td><a href="<?php echo site_url("administrador/descargaManualCargaDirectorio"); ?>">Descargar manual de carga del directorio (*.pdf)&nbsp;<img src="<?php echo base_url("images/acrobat.png")?>"></img></a></td>
		</tr>
		<tr>
